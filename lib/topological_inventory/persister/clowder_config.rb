...
ENV["QUEUE_HOST"] = TopologicalInventory::Persister::ClowderConfig.instance["kafkaHost"]
ENV["QUEUE_PORT"] = TopologicalInventory::Persister::ClowderConfig.instance["kafkaPort"].to_s

# ManageIQ Logger depends on these variables
ENV['CW_AWS_ACCESS_KEY_ID']     = TopologicalInventory::Persister::ClowderConfig.instance["awsAccessKeyId"]
ENV['CW_AWS_SECRET_ACCESS_KEY'] = TopologicalInventory::Persister::ClowderConfig.instance["awsSecretAccessKey"]
